...
namespace SaleProject.Migrations
{
    ...
    public partial class newdatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SaleInvoiceProducts",
                columns: table => new
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    SaleInvoiceId = table.Column<string>(type: "text", nullable: false),
                    ProductId = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleInvoiceProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SaleInvoiceProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleInvoiceProducts_SaleInvoices_SaleInvoiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleInvoiceProducts_ProductId",
                table: "SaleInvoiceProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleInvoiceProducts_SaleInvoiceId",
                table: "SaleInvoiceProducts",
